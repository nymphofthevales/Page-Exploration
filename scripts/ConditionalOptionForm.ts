...
import { NodeDependencyData, NodeDependencyRule, ScoreDependencyRule, StoryOption } from "./StoryOption.js"
...
export class ConditionalOptionForm {
    ...
    structure : {
        formVisibilitySelectors: {
            "check-isconditional": HTMLInputElement,
            "check-showif": HTMLInputElement,
            "check-showif-visited": HTMLInputElement,
            "check-showif-scored": HTMLInputElement,
            "check-hideif": HTMLInputElement,
            "check-hideif-visited": HTMLInputElement,
            "check-hideif-scored": HTMLInputElement
        },
        addRules: {
            "showif-visited-addrule": HTMLElement,
            "showif-scored-addrule": HTMLElement,
            "hideif-visited-addrule": HTMLElement,
            "hideif-scored-addrule": HTMLElement
        },
        contentContainers: {
            "content-container": DynamicElement,
            "showHideForm-content-container": DynamicElement,
            "showif-visitedScoredForm-content-container": DynamicElement,
            "showif-visited-rulesForm-content-container": DynamicElement,
            "showif-scored-rulesForm-content-container": DynamicElement,
            "hideif-visitedScoredForm-content-container": DynamicElement,
            "hideif-visited-rulesForm-content-container":DynamicElement,
            "hideif-scored-rulesForm-content-container": DynamicElement
        }
    } = {
        formVisibilitySelectors: {
    ...
    dependencyRules:{
        "showif-visited": NodeDependencyRuleForm[],
        "showif-scored": ScoreDependencyRuleForm[],
        "hideif-visited": NodeDependencyRuleForm[],
        "hideif-scored": ScoreDependencyRuleForm[]
    } = {
        "showif-visited": [],
        "showif-scored": [],
        "hideif-visited": [],
    ...
    constructor(story: Story, option: StoryOption) {
        this.story = story
        this.option = option
    }
    anchorTo(destination: HTMLElement) {
    ...
    toggleCheck(checkbox: HTMLInputElement) {
        checkbox.checked = !checkbox.checked;
        this.fireChange(checkbox)
    }
    check(checkbox: HTMLInputElement) {
    ...
    fireChange(element: HTMLElement) {
    ...
    addNodeRuleFromData(dependencyRule: NodeDependencyRule) {
        let form = this.addRule("showif-visited")
        let data =  dependencyRule.dependencyData
        form.set(data)
    }
    addScoreRuleFromData(dependencyRule: ScoreDependencyRule) {
    ...
    */
    ...
    createVisibilitySelectorListeners(): void {
   ...
   generateDependencyNameFromButtonId(id) {
    ...
    get existsInDocument(): boolean {
        return !!this.mainContentContainer
    }
    get mainContentContainer(): HTMLElement | null {
     ...
     * 
    */
    generateConditionalOptionHTML(): string {
            ...
            this.showHideForm(baseID, 
                ...
                this.wrapperDiv( baseID + `showHideForm` + `-content-container`, false,
                    this.showIfForm(baseID, 
                        ...
                        this.wrapperDiv( baseID + `showif-visitedScoredForm` + `-content-container`, false,
                            this.showIfVisitedRulesForm(baseID, 
                                this.showIfVisitedCheckbox(baseID) + 
                                this.wrapperDiv( baseID + `showif-visited-rulesForm` + `-content-container`, false,
                                    this.rulesFormContent(baseID, "show", "visited")
                                )
                            ) + 
                            this.showIfScoredRulesForm(baseID, 
                                this.showIfScoredCheckbox(baseID) + 
                                this.wrapperDiv( baseID + `showif-scored-rulesForm` + `-content-container`, true,
                    ...
                    this.hideIfForm(baseID, 
                        ...
                        this.wrapperDiv( baseID + `hideif-visitedScoredForm` + `-content-container`, true,
                            this.hideIfVisitedRulesForm(baseID, 
                                this.hideIfVisitedCheckbox(baseID) + 
                                this.wrapperDiv( baseID + `hideif-visited-rulesForm` + `-content-container`, true,
                                    this.rulesFormContent(baseID, "hide", "visited")
                                )
                            ) +  
                            this.hideIfScoredRulesForm(baseID, 
                                this.hideIfScoredCheckbox(baseID) +
                                this.wrapperDiv( baseID + `hideif-scored-rulesForm` + `-content-container`, true,
...
class NodeDependencyRuleForm {
    ...
    inputs: Form
    nodes: number
    constructor(option: StoryOption, target: HTMLElement) {
        console.log(target)
        this.option = option
        this.nodes = 0;
    ...
    set(data: NodeDependencyData): void {
        this.reset()
    ...
    generateAdditionalNodeHTML(number: number) {
        return `
